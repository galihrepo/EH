...
public class AdapterSchedule extends RecyclerView.Adapter<AdapterSchedule.ViewHolder> {
    private List<PatientsScheduleResponse> mDataset;
    ...
    public AdapterSchedule(Context context, List<PatientsScheduleResponse> myDataset) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        PatientsScheduleResponse data = mDataset.get(position);
        holder.tvClinic.setText(data.getClinicName());
